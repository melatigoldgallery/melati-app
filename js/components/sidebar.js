...
function setupSidebarToggle() {
  ...
  // Support both .app-container and .wrapper
  const appContainer =
    document.querySelector('.app-container') || document.querySelector('.wrapper')
...
function setupMobileSidebar() {
  ...
  if (hamburgerBtn) {
    ...
    newHamburger.addEventListener('click', function (e) {
      ...
      document.body.style.overflow = appContainer.classList.contains('sidebar-active')
        ? 'hidden'
        : ''
    })
  }
  ...
  document.addEventListener('click', function (e) {
    ...
    if (
      currentAppContainer &&
      currentSidebar &&
      currentAppContainer.classList.contains('sidebar-active') &&
      !currentSidebar.contains(e.target) &&
      (!currentHamburger || !currentHamburger.contains(e.target))
    ) {
      currentAppContainer.classList.remove('sidebar-active')
      document.body.style.overflow = ''
    }
  })
